...
var education = {
    ...
    display: function () {
        ...
        for (item in education.schools) {
            ...
            formattedHTMLschoolName = HTMLschoolName.replace("%data%", education.schools[item].name)
                .replace("#", education.schools[item].url);
            formattedHTMLschoolDegree = HTMLschoolDegree.replace("%data%", education.schools[item].degree);
            ...
            formattedHTMLschoolLocation = HTMLschoolLocation.replace("%data%", education.schools[item].location);
            formattedHTMLschoolMajor = HTMLschoolMajor.replace("%data%", education.schools[item].majors);
        ...
        for (item in education.onlineCourses) {
            $("#education").append(HTMLschoolStart);
            formattedHTMLonlineTitle = HTMLonlineTitle.replace("%data%", education.onlineCourses[item].title)
                .replace("#", education.onlineCourses[item].url);
            formattedHTMLonlineSchool = HTMLonlineSchool.replace("%data%", education.onlineCourses[item].school);
            formattedHTMLonlineDates = HTMLonlineDates.replace("%data%", education.onlineCourses[item].dates);
            formattedHTMLonlineURL = HTMLonlineURL.replace("%data%", education.onlineCourses[item].url)
                .replace("#", education.onlineCourses[item].url);
...
var work = {
    ...
    display: function () {
        ...
        for (item in work.jobs) {
            ...
            formattedWorkExperience = HTMLworkEmployer.replace("%data%", work.jobs[item].employer);
            formattedWorkTitle = HTMLworkTitle.replace("%data%", work.jobs[item].title);
...
var projects = {
    ...
    display: function () {
        ...
        for (item in projects.project) {
            ...
            formattedProjectTitle = HTMLprojectTitle.replace("%data%", projects.project[item].title);
            formattedProjectDate = HTMLprojectDates.replace("%data%", projects.project[item].date);
            formattedProjectDesc = HTMLprojectDescription.replace("%data%", projects.project[item].description);
            ...
            for (image in projects.project[item].image) {
                formattedHTMLprojectImage = HTMLprojectImage.replace("%data%", projects.project[item].image[image]);
